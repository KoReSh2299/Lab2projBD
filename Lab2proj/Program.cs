...
namespace Lab2proj
{
    internal class Program
    {
        ...
        static public void Task1(KursachContext db)
        {
        ...
        static public void Task2(KursachContext db)
        {
        ...
        static public void Task3(KursachContext db)
        {
        ...
        static public void Task4(KursachContext db)
        {
        ...
        static public void Task5(KursachContext db)
        {
        ...
        static public void Task6(KursachContext db)
        {
        ...
        static public void Task7(KursachContext db)
        {
        ...
        static public void Task8(KursachContext db)
        {
        ...
        static public void Task9(KursachContext db)
        {
        ...
        static public void Task10(KursachContext db)
        {
